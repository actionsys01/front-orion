...
function Dacte(
        ...
        cteGatheredData.push({
            ...
            tomadorEnder:
                item.informacoes_cte.toma3?.toma === '0'
                    ...
                    : null,
            // fluxo
            fluxoOrig: item.complemento.fluxo
                ? item.complemento.fluxo.xOrig
                : '',
            fluxoPass: item.complemento.fluxo
                ? item.complemento.fluxo.xPass
                : '',
            fluxoDest: item.complemento.fluxo
                ? item.complemento.fluxo.xDest
                : '',
    ...
    const headerFirstRow = cteData.map((item: any) => {
        return [
            ...
            {
                text: item.informacoes_cte.modal,
                fontSize: 10,
                bold: true,
                alignment: 'center',
    ...
    const headerSecondRow = cteGatheredData.map((item: any) => {
        return [
            ...
            {
                text: item.informacoes_cte.serie,
                alignment: 'center',
                fontSize: 7,
                bold: true,
                border: [true, false, false, true],
    ...
    const generalFirstRow = cteGatheredData.map((item: any) => {
        return [
            {
                text: item.informacoes_cte?.tpCTe,
                bold: true,
                fontSize: 7,
                alignment: 'center',
                border: [true, false, false, true],
            ...
            {
                text: item.informacoes_cte?.tpServ,
                bold: true,
                fontSize: 7,
                alignment: 'center',
                border: [true, false, false, true],
    ...
    const generalSecondRow = cteData.map((item: any) => {
        return [
            {
                text: item.informacoes_cte?.natOp,
                fontSize: 6,
                bold: true,
                alignment: 'center',
                border: [true, false, false, true],
            ...
            {
                text: item.emitente?.enderEmit.xMun,
                fontSize: 7,
                bold: true,
                alignment: 'center',
                border: [true, false, false, true],
    ...
    const impostosFirstRow = cteGatheredData.map((item: any) => {
        return [
            ...
            {
                text: item.ICMS.vBC || item.ICMS.vBCOutraUF,
                fontSize: 7,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
            ...
            {
                text: item.ICMS.pICMS || item.ICMS.pICMSOutraUF,
                fontSize: 7,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
            ...
            {
                text: item.ICMS.vICMS || item.ICMS.vICMSOutraUF,
                fontSize: 7,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
            ...
            {
                text: item.ICMS.pRedBC || item.ICMS.pRedBCOutraUF,
                fontSize: 7,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
    ...
    const documentsFirstRow = cteData.map((item: any) => {
        return [
            {
                text: item.informacoes_normal_substituto.infDoc.infNF?.mod,
                fontSize: 7,
                alignment: 'center',
                border: [true, false, true, true],
            },
            ...
            {
                text: item.informacoes_normal_substituto.infDoc.infNF?.serie,
                fontSize: 7,
                alignment: 'center',
                border: [true, false, true, true],
            },
    ...
    const details: any = [
        ...
        },
        {
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        {
                            text: 'CFOP - NATUREZA DA OPERAÇÃO',
                            fontSize: 4,
                            alignment: 'center',
                            border: [true, true, true, false],
                        },
                        {
                            text: 'INÍCIO DA PRESTAÇÃO',
                            fontSize: 4,
                            alignment: 'center',
                            border: [true, true, true, false],
                        },
                        {
                            text: 'FIM DA PRESTAÇÃO',
                            fontSize: 4,
                            alignment: 'center',
                            border: [true, true, true, false],
                        },
        ...
        },
        {
            ...
            table: {
                ...
                body: [
                    [
                        {
                            text: 'PRODUTO PREDOMINANTE',
                            fontSize: 4,
                            alignment: 'center',
                            border: [true, true, true, false],
                        },
                        {
                            text: 'OUTRA CARACTERÍSTICA',
                            fontSize: 4,
                            alignment: 'center',
                            border: [true, true, true, false],
                        },
                        {
                            text: 'VALOR TOTAL DA CARGA',
                            fontSize: 4,
                            alignment: 'center',
                            border: [true, true, true, false],
                        },
        ...
        {
            text: 'COMPONENTES DO VALOR DA PRESTAÇÃO',
            fontSize: 7,
            alignment: 'center',
            bold: true,
            margin: [0, 2, 0, 1],
        ...
        {
            text: 'INFORMAÇÕES RELATIVAS A IMPOSTOS',
            fontSize: 7,
            alignment: 'center',
            bold: true,
            margin: [0, 2, 0, 1],
            ...
            table: {
                ...
                body: [
                    [
                        ...
                        {
                            text: 'CNPJ/CPF EMITENTE',
                            fontSize: 4,
                            alignment: 'center',
                            border: [true, true, true, false],
                        },
                        {
                            text: 'SÉRIE/Nº DOCUMENTO',
                            fontSize: 4,
                            alignment: 'center',
                            border: [true, true, true, false],
                        },
