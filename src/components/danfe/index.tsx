...
function Danfe(nfeData: any, nfeFrontData: any, products: any) {
    ...
    const details: any = [
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {
                            text: 'INSCRIÇÃO ESTADUAL DO SUBST. TRIBUT.',
                            fontSize: 4,
                            border: [true, true, true, false],
                        },
                        {
            ...
            table: {
                ...
                body: [
                    [
                        ...
                        {
                            text: 'DESCRIÇÃO DO PRODUTO /SERVIÇO',
                            fontSize: 4,
                            alignment: 'center',
                            border: [true, true, true, true],
                        },
        ...
        {
            text: 'DADOS ADICIONAIS / INFORMAÇÕES COMPLEMENTARES',
            fontSize: 8,
            bold: true,
            margin: [0, 3, 0, -10],
        },
