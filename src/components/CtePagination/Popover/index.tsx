import { Popover, Text, useToasts } from '@geist-ui/react';
    ...
    const printData = useCallback(async chave_nota => {
        ...
        try {
            ...
            if (Array.isArray(cteResponse)) {
                ...
                const produtos = cteResponse.map(
                    item => item.valores_servicos.Comp,
                );
                Dacte(cteResponse, medidas, produtos, chave_nota);
            } else {
                cteData.push(cteResponse);
                const medidas =
                    cteResponse.informacoes_normal_substituto.infCarga.infQ;
                        ...
                        <Popover.Item>
                            <Text
                                ...
                                onClick={() => {
                                    ...
                                    const status_sefaz = Number(
                                        item.rowValue.sefaz_status,
                                    );
