    ...
    <RadioFilterComponent>
      <FormControl component="fieldset">
        ...
        >
          ...
          <FormControlLabel value="0" control={<Radio />} label="Na Portaria" />
          <FormControlLabel value="1" control={<Radio />} label="Autorizado" />
          <FormControlLabel value="2" control={<Radio />} label="Fechado" />
