...
function Danfse(data, chave_nota) {
    ...
    const formatData = data.map((item: NfseFormattedProps) => {
        formattedData.push({
            ...
            serviceDate: format(
                new Date(item.dtPrestacaoServico),
                'dd/MM/yyyy HH:mm',
            ),
    ...
    const prestadorFirstRow = formattedData.map((item: NfseFormattedProps) => {
        return [
            {
                text: item.dadosPrestador.razaoSocial,
                fontSize: 8,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
            ...
            {
                text: item.dadosPrestador.inscricaoMunicipal,
                colSpan: 3,
                fontSize: 8,
                bold: true,
                alignment: 'center',
    ...
    const prestadorSecondRow = formattedData.map((item: NfseFormattedProps) => {
        return [
            ...
            {
                text: item.dadosPrestador.endereco.logradouro,
                fontSize: 8,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
            ...
            {
                text: item.dadosPrestador.endereco.municipio,
                fontSize: 8,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
            ...
            {
                text: item.dadosPrestador.endereco.uf,
                fontSize: 8,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
    ...
    const tomadorFirstRow = formattedData.map((item: NfseFormattedProps) => {
        return [
            {
                text: item.dadosTomador.razaoSocial,
                fontSize: 8,
                colSpan: 4,
                bold: true,
                alignment: 'center',
    ...
    const tomadorThirdRow = formattedData.map((item: NfseFormattedProps) => {
        return [
            {
                text: item.dadosTomador.endereco.municipio,
                fontSize: 8,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
            ...
            {
                text: item.dadosTomador.endereco.uf,
                fontSize: 8,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
            ...
            {
                text: item.dadosTomador.contato.telefone,
                fontSize: 8,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
            ...
            {
                text: item.dadosTomador.endereco.cep,
                fontSize: 8,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
    ...
    const tomadorFourthRow = formattedData.map((item: NfseFormattedProps) => {
        return [
            {
                text: item.dadosTomador.contato.email,
                fontSize: 8,
                colSpan: 4,
                bold: true,
                alignment: 'center',
    ...
    const tomadorFifthRow = formattedData.map((item: NfseFormattedProps) => {
        return [
            ...
            {
                text: item.dadosTomador.inscricaoMunicipal,
                fontSize: 8,
                colSpan: 2,
                bold: true,
                alignment: 'center',
    ...
    const intermediarioFirstRow = formattedData.map(
        (item: NfseFormattedProps) => {
            return [
                {
                    text: item.dadosIntermediario.razaoSocial,
                    fontSize: 8,
                    bold: true,
                    alignment: 'center',
                    border: [true, false, true, true],
                ...
                {
                    text: item.dadosIntermediario.cnpj,
                    fontSize: 8,
                    bold: true,
                    alignment: 'center',
                    border: [true, false, true, true],
                ...
                {
                    text: item.dadosIntermediario.inscricaoMunicipal,
                    fontSize: 8,
                    bold: true,
                    alignment: 'center',
                    border: [true, false, true, true],
    ...
    const intermediarioSecondRow = formattedData.map(
        (item: NfseFormattedProps) => {
            return [
                {
                    text: item.dadosIntermediario.contato.email,
                    fontSize: 8,
                    colSpan: 2,
                    bold: true,
                    alignment: 'center',
                ...
                {
                    text: item.dadosIntermediario.contato.telefone,
                    fontSize: 8,
                    bold: true,
                    alignment: 'center',
                    border: [true, false, true, true],
    ...
    const servicesTable = formattedData.map((item: NfseFormattedProps) => {
        return [
            {
                text: item.descricaoTipoServico,
                fontSize: 7,
                bold: true,
                alignment: 'left',
                border: [true, false, true, true],
    ...
    const impostosSecondRow = formattedData.map((item: NfseFormattedProps) => {
        return [
            ...
            {
                text: item.impostosRetidos.alqIrrf,
                fontSize: 6,
                bold: true,
                alignment: 'center',
                border: [true, false, true, false],
            ...
            {
                text: item.impostosRetidos.vlrIrrf,
                fontSize: 6,
                bold: true,
                alignment: 'center',
                border: [true, false, true, false],
    ...
    const impostosThirdRow = formattedData.map((item: NfseFormattedProps) => {
        return [
            ...
            {
                text: item.impostosRetidos.alqCofins,
                fontSize: 6,
                bold: true,
                alignment: 'center',
                border: [true, false, true, false],
            ...
            {
                text: item.impostosRetidos.vlrCofins,
                fontSize: 6,
                bold: true,
                alignment: 'center',
                border: [true, false, true, false],
    ...
    const totalValueFirstRow = formattedData.map((item: NfseFormattedProps) => {
        return [
            {
                text: item.impostosRetidos.vlrInss,
                fontSize: 7,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
            ...
            {
                text: item.impostosRetidos.vlrCsll,
                fontSize: 7,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
            ...
            {
                text: item.impostosRetidos.vlrPisPasep,
                fontSize: 7,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
    ...
    const totalValueSecondRow = formattedData.map(
        (item: NfseFormattedProps) => {
            return [
                {
                    text: item.itemListaServico,
                    fontSize: 7,
                    colSpan: 5,
                    bold: true,
                    alignment: 'center',
    ...
    const totalValueThirdRow = formattedData.map((item: NfseFormattedProps) => {
        return [
            ...
            {
                text: item.impostosRetidos.vlrIssRetido,
                fontSize: 7,
                bold: true,
                alignment: 'center',
                border: [true, false, true, true],
    ...
    const totalValueFourthRow = formattedData.map(
        (item: NfseFormattedProps) => {
            return [
                {
                    text: item.municipioIncidencia,
                    fontSize: 7,
                    colSpan: 2,
                    bold: true,
                    alignment: 'center',
                ...
                {
                    text: item.construcaoCivil.codigoObra,
                    fontSize: 7,
                    colSpan: 2,
                    bold: true,
                    alignment: 'center',
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        ...
                        {
                            text: 'DATA E HORA DO SERVIÇO',
                            alignment: 'center',
                            fontSize: 4,
                            border: [true, true, true, false],
                        },
                        {
                            text: 'CÓDIGO VERIFICADOR',
                            fontSize: 4,
                            alignment: 'center',
                            border: [true, true, true, false],
                        },
        ...
        },
        {
            ...
            table: {
                ...
                body: [
                    ...
                    [
                        {
                            text: 'MUNICÍPIO DA PRESTAÇÃO DO SERVIÇO',
                            colSpan: 2,
                            alignment: 'center',
                            fontSize: 4,
                            border: [true, true, true, false],
                        ...
                        {
                            text: 'NÚMERO DA INSCRIÇÃO DA OBRA',
                            colSpan: 2,
                            alignment: 'center',
                            fontSize: 4,
                            border: [true, true, true, false],
                        ...
                        {
                            text: 'VALORAPROXIMADO DOS TRIBUTOS',
                            colSpan: 2,
                            alignment: 'center',
                            fontSize: 4,
                            border: [true, true, true, false],
