...
type NotaProps = INfeDto & CteProps;
  ...
  async function updateEntrance() {
    ...
    try {
      await entrances.updateEntrance(controlId, {
        ...
        peso_vazio:
          entrance.emptyWeight.toString() === '' ? 0 : entrance.emptyWeight,
        empresa: company_id,
            ...
            <div>
              ...
              <div>
                <span className="icon">
                  Reboque
                  <Checkbox
                    checked={reboque ? reboque || visible : visible}
            ...
            <Column>
              <div>
                ...
                <input
                  ...
                  onFocus={
                    entranceFinished ? () => '' : () => setEntranceFocus(true)
                  }
                />
              </div>
              <div>
                ...
                <input
                  ...
                  value={
                    !exitFocus
                      ? format(new Date(exitDate), 'yyyy-MM-dd')
                      : dataSaida
                  }
                  onChange={e => {
                  ...
                  onFocus={
                    entranceFinished ? () => '' : () => setExitFocus(true)
                  }
                />
              </div>
            </Column>
            <Column>
              ...
              <div>
                ...
                <input
                  ...
                  readOnly={entranceFinished}
                  value={
                    !exitFocus ? format(new Date(exitDate), 'HH:mm') : exitTime
                  }
                  onChange={e => {
                    setExitTime(e.target.value), setHasSChanged(true);
                  }}
                  onFocus={
                    entranceFinished ? () => '' : () => setExitFocus(true)
                  }
