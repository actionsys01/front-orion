...
import { Section, InlineInputs, RightInput, BtnRow } from './style';
...
export default function CertificadoDigital() {
  ...
  async function getCerficateData() {
    try {
      ...
      setPageData({
        ...pageData,
        initialDate: data.data_inicio,
        expiringDate: data.data_vencimento,
      });
      return data;
    } catch (error) {
      // console.log(error)
  ...
  async function deleteCertificate() {
    try {
      await companyRequest.deleteCertificate(
  ...
  return (
    <>
      ...
      >
              ...
              <InlineInputs>
                ...
                <div>
                  ...
                  <input
                    ...
                    value={
                      isCertificated
                        ? format(new Date(pageData.initialDate), 'dd/MM/yyyy')
                        : ''
                    }
                  />
                  <span>Até:</span>
                  <input
                    ...
                    value={
                      isCertificated
                        ? format(new Date(pageData.expiringDate), 'dd/MM/yyyy')
                        : ''
                    }
                  />
                </div>
        ...
        <BtnRow>
          <button
            disabled={!certificatePermissions.EXCLUIR}
          ...
          <button
            disabled={!certificatePermissions.ADICIONAR}
      ...
      {secondModal && <CnpjsModal secondModalHandler={secondModalHandler} />}
      {deleteModal && (
        <DeletarModal
