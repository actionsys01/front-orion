...
import { X, FilePlus } from '@geist-ui/react-icons';
...
const Modal = ({
  ...
  async function sendData() {
    if (
      pageData.initialDate.getFullYear() > pageData.expiringDate.getFullYear()
    ) {
      setToast({
    ...
    if (
      pageData.initialDate.getFullYear() ===
        pageData.expiringDate.getFullYear() &&
                ...
                <InputsContainer>
                  ...
                  <input
                    ...
                    onChange={e =>
                      setPageData({
                        ...pageData,
                        expiringDate: new Date(e.target.value),
                      })
                    }
                  />
                  <span>Senha:</span>
