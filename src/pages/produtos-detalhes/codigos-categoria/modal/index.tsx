...
import {
  ModalStyle,
  TableModalStyle,
} from '@pages/produtos/codigos-categoria/modal/style';
...
interface IModal {
  ...
  appToggled: IToggle;
  setAppToggled: Dispatch<SetStateAction<IToggle>>;
}

const TableModalDetalhes = ({
  id,
  setVisibleModal,
  setAppIds,
  appIds,
...
export default TableModalDetalhes;
