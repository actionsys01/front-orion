...
export default function AbaCte({ data } : AbaProps) {
  ...
  return <>
    ...
    <DadosStyle>
      <div>
        <div className="header" onClick={() => setModalRemetente(!modalRemetente)}>
        ...
        <>
          ...
          <LineStyle>
            <div>
              <h5>Bairro</h5>
              <h6>{data?.remetente?.enderReme?.xBairro}</h6>
            </div>
            <div>
              <h5>Município</h5>
    ...
    <DadosStyle>
      <div>
        <div className="header" onClick={() => setModalEmitente(!modalEmitente)}>
    ...
    <DadosStyle>
      <div>
        <div className="header" onClick={() => setModalDestinatario(!modalDestinatário)}>
      ...
      <div>
        ...
        <div>
          ...
          <div>
            ...
            <h6>{data?.informacoes_cte?.UFIni} - {data?.informacoes_cte?.xMunIni}</h6>
          </div>
          <div>
            <h5>Fim da Prestação</h5>
            <h6>{data?.informacoes_cte?.UFFim} - {data?.informacoes_cte?.xMunFim}</h6>
          </div>
        </div>
      </div>
    </CardStyle>
