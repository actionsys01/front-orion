      ...
      <CardStyle>
        <div>
          ...
          <LineStyle>
            <div>
              <h5>BC do ST Ret</h5>
              <h6>{data?.impostos?.ICMS?.ICMS60?.vBCSTRet}</h6>
            </div>
            <div>
              <h5>Valor do ICMS ST Ret</h5>
              <h6>{data?.impostos?.ICMS?.ICMS60?.vICMSSTRet}</h6>
            </div>
            <div>
              <h5>Alíquota de Redução do ICMS ST Ret</h5>
              <h6>{data?.impostos?.ICMS?.ICMS60?.pICMSSTRet}</h6>
            </div>
            {/* <div>
          ...
          <LineStyle>
            <div>
              ...
              <h6>{data?.impostos?.ICMS?.ICMSOutraUF?.vBCOutraUF}</h6>
            </div>
            <div>
              <h5>Alíquota ICMS Outra UF</h5>
              <h6>{data?.impostos?.ICMS?.ICMSOutraUF?.pICMSOutraUF}</h6>
            </div>
            <div>
              <h5>Valor ICMS Outra UF</h5>
              <h6>{data?.impostos?.ICMS?.ICMSOutraUF?.vICMSOutraUF}</h6>
            </div>
          </LineStyle>
        </div>
      </CardStyle>
