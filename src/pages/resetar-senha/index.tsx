      ...
      <>
        ...
        <Container>
          ...
          <h6 style={{ textAlign: 'center' }}>
            Aparentemente a senha já foi redefinida, caso deseje redefinir a
            senha novamente
            <br /> dirija-se à sessão redefinir senha clicando no botão abaixo.
          </h6>
  ...
  return (
    <>
      ...
      <Container>
        <h4>Seja Bem-Vindo(a) {companyFeatures?.nome}!</h4>
        <h6>
          Por favor escolha a sua nova senha, esta senha será utilizada para
