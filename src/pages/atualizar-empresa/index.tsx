...
export default function AtualizarEmpresa() {
    ...
    const [company, setCompany] = useState<string>(
        router.query.nome_fantasia as string,
    );
    ...
    const [socialName, setSocialName] = useState<string>(
        router.query.razao_social as string,
    );
    const [account, setAccount] = useState<number>(
        Number(router.query.accouuntId),
    );
    ...
    async function updateCompany() {
        try {
            await companies.update({
                empresa_id: Number(router.query.id),
            ...
            <CompanyRegister>
                <div>
                    <div className="container">
                        ...
                        <select
                            defaultValue={router.query.accountName}
