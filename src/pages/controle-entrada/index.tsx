                            ...
                            content={[
                                {
                                    ...
                                    onClick: !entrancePermissions.AUTORIZAR
                                        ...
                                        ? () =>
                                              handleApproval(
                                                  item.controle_entrada.id,
                                              )
                                        : item.controle_entrada?.status === 4
                                        ? () => {
                                              setModalStatus('exception'),
                                                  modalVisibleHandler();
                                          }
                                        : () => '',
                                ...
                                },
                                {
                                    ...
                                    className: entrancePermissions.EDITAR
                                        ? 'able'
                                        : 'disabled',
                                },
                                {
                                    ...
                                    className: entrancePermissions.CANCELAR
                                        ? 'able'
                                        : 'disabled',
                                },
                            ]}
            ...
            <BtnRow>
                ...
                <div>
                    ...
                    <button
                        ...
                        className={
                            entrancePermissions.ADICIONAR ? 'add' : 'disabled'
                        }
                        onClick={() =>
                            router.push({ pathname: '/cadastrar-entrada' })
                        }
                    >
                        <span>
                            <Plus />
                            ...
                            {gatheredData.map(
                                (item: EntranceDataProps, i: any) => (
                                    <tr key={i}>
                                        ...
                                        <td>
                                            {item.controle_entrada?.peso_cheio}
                                        </td>
